...
class TestRWLock(unittest.TestCase):
	...
	def setUp(self) -> None:
		"""Test setup."""
		self.c_rwlock_type_downgradable = tuple() # (rwlock.RWLockReadD, rwlock.RWLockWriteD, rwlock.RWLockFairD) # TODO
...
class TestRWLockSpecificCase(unittest.TestCase):
	...
	def setUp(self) -> None:
		"""Test setup."""
		self.c_rwlock_type_downgradable = tuple() # (rwlock.RWLockWriteD, rwlock.RWLockFairD, rwlock.RWLockReadD) #TODO
		self.c_rwlock_type = (rwlock.RWLockRead, rwlock.RWLockWrite, rwlock.RWLockFair) + self.c_rwlock_type_downgradable
